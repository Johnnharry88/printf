...
/* Modifiers */
unsigned int print_width(shield_t *output, unsigned int printed,
		unsigned char flags, int wid);
unsigned int print_string_width(shield_t *output,
		unsigned char flags, int wid, int prec, int size);
unsigned int print_neg_width(shield_t *output, unsigned int printed,
		unsigned char flags, int wid);
